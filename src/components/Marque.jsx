...
<div className="space-y-5">
  ...
  <div className="flex gap-10 items-center">
    <span className="flex border border-gray-600 bg-neutral-800 rounded px-2 py-1 items-center gap-2">
    ...
    <span className="mr-10 flex border border-gray-600 bg-neutral-800 rounded px-2 py-1 items-center gap-2">
  ...
  <div className="flex items-center gap-10">
    <span className="ml-10 flex border border-gray-600 bg-neutral-800 rounded px-2 py-1 items-center gap-2">
    ...
    <span className="mr-2 flex border border-gray-600 bg-neutral-800 rounded px-2 py-1 items-center gap-2">
