...
const About = () => {
    return (
        <div id="about">
            {/* About Section Text */}
            <div className="text-black dark:text-white flex flex-col font-hanken rounded-xl px-6 py-4">
                <div>
                    ...
                    <p className="text-md text-neutral-600 dark:text-neutral-400 leading-relaxed mt-2">
            ...
            <div className="text-black dark:text-white font-hanken rounded-xl px-6 py-4">
                <h1 className="text-2xl font-hanken font-semibold mb-6">Education</h1>
